...
public class CstWorkBookStyle {
     ...
     * @param obj the obj
     */
    public CstWorkBookStyle(Object obj) {
        if (obj == null) {
            return;
        }
     ...
     */
    public CstWorkBookStyle updateNumberType() {
        updateformat("#,##0");
     ...
     * @return the to work book style
     */
    public CstWorkBookStyle updateDateType() {
        this.format = 0xe;
        return this;
    }
     ...
     * @return the to work book style
     */
    public CstWorkBookStyle updateTitleType() {
        this.fillForegroundColor = IndexedColors.GREY_25_PERCENT;
        this.fillPattern = 1;

        this.font = CstWorkBookFont.builder().boldWeight((short) 700).fontHeightInPoints((short) 12).build();
        return this;
    }
    ...
    public CellStyle convertOriginStyle(@NonNull Workbook wb) {
        ...
        cellStyle.setAlignment(HorizontalAlignment.forInt(this.alignment.ordinal()));
        cellStyle.setVerticalAlignment(VerticalAlignment.forInt(this.verticalAlignment.ordinal()));
        /*cellStyle.setBorderTop(this.borderTop.ordinal());
        cellStyle.setBorderBottom( this.borderBottom.ordinal());
        cellStyle.setBorderLeft( this.borderLeft.ordinal());
        cellStyle.setBorderRight( this.borderRight.ordinal());*/
        ...
        if (this.fillPattern != null) {
            cellStyle.setFillPattern(FillPatternType.forInt(this.fillPattern));
        }
        if (this.font != null) {
